...
namespace MyCompany.Forms.PlatformConfiguration.Tizen
{
    using System.Linq;
    using Xamarin.Forms;
    using Xamarin.Forms.PlatformConfiguration;
    ...
    public static class Shadow
    {
        ...
        public static bool IsShadowed(this IPlatformElementConfiguration<Tizen, FormsElement> config)
        {
            return GetIsShadowed(config.Element);
        }

        public static IPlatformElementConfiguration<Tizen, FormsElement> SetIsShadowed(this IPlatformElementConfiguration<Tizen, FormsElement> config, bool value)
        {
            SetIsShadowed(config.Element, value);
            return config;
        }
