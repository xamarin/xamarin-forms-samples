    ...
    public class AnimalsViewModel
    {
        ...
        void CreateAnimalsCollection()
        {
            if (includeEmptyGroups)
                Animals.Add(new Animal("Aardvarks", new List<AnimalDetails>()));

            Animals.Add(new Animal("Bears", new List<AnimalDetails>
            {
                new AnimalDetails
                {
            ...
            Animals.Add(new Animal("Cats", new List<AnimalDetails>
            {
                new AnimalDetails
                {
                    Name = "Abyssinian",
            ...
            Animals.Add(new Animal("Dogs", new List<AnimalDetails>
            {
                new AnimalDetails
                {
                    Name = "Afghan Hound",
            ...
            Animals.Add(new Animal("Elephants", new List<AnimalDetails>
            {
                new AnimalDetails
                {
            ...
            if (includeEmptyGroups)
                Animals.Add(new Animal("Horses", new List<AnimalDetails>()));

            Animals.Add(new Animal("Monkeys", new List<AnimalDetails>
            {
                new AnimalDetails
                {
                    Name = "Baboon",
