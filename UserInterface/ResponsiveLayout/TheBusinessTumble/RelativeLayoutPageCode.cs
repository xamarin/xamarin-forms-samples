...
namespace ResponsiveLayout
{
	public class RelativeLayoutPageCode : ContentPage
	{
		public RelativeLayoutPageCode ()
		{
			...
			innerLayout.Children.Add (new Label { Text = "deer,jpg", XAlign = TextAlignment.Center }, Constraint.RelativeToParent ((parent) => {
				return 0;
			...
			outerLayout.Children.Add (new Button { Text = "Previous", BackgroundColor = Color.White, TextColor = Color.Green, BorderRadius = 0 }, Constraint.RelativeToParent ((parent) => {
				return 0;
			}), Constraint.RelativeToParent ((parent) => {
				return parent.Height - 60;
			}), Constraint.RelativeToParent ((parent) => {
			...
			outerLayout.Children.Add (new Button { Text = "Next", BackgroundColor = Color.White, TextColor = Color.Green, BorderRadius = 0 }, Constraint.RelativeToParent ((parent) => {
				return parent.Width * .5;
			}), Constraint.RelativeToParent ((parent) => {
				return parent.Height - 60;
			}), Constraint.RelativeToParent ((parent) => {
