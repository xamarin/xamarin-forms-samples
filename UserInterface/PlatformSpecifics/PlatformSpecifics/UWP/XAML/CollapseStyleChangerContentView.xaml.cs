...
namespace PlatformSpecifics
{
    ...
    {
        public static readonly BindableProperty ParentPageProperty = BindableProperty.Create("ParentPage", typeof(Xamarin.Forms.FlyoutPage), typeof(CollapseStyleChangerContentView), null, propertyChanged:OnParentPagePropertyChanged);
