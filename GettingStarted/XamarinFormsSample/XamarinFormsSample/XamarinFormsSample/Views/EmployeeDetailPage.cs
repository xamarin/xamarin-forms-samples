            ...
            Grid inputGrid = new Grid
                             {
                                 ...
                                 Children =
                                 {
					{ new Label { Text = "First Name:", FontFamily = Fonts.SmallTitle.FontFamily, FontSize = Fonts.SmallTitle.FontSize, TextColor = Colours.SubTitle }, 0, 0 },
					{ new Label { Text = "Last Name:", FontFamily = Fonts.SmallTitle.FontFamily, FontSize = Fonts.SmallTitle.FontSize, TextColor = Colours.SubTitle }, 0, 1 },
					{ new Label { Text = "Twitter: ", XAlign = TextAlignment.End, FontFamily = Fonts.SmallTitle.FontFamily, FontSize = Fonts.SmallTitle.FontSize, TextColor = Colours.SubTitle }, 0, 2 },
